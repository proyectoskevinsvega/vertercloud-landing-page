          ...
          services: {
            ...
            items: {
              vpn: {
                ...
                action: 'Go',
                url: import.meta.env.VITE_VPN_URL || 'https://bravexcolombia.com/vpn',
              },
              auth: {
                title: 'VerterAuth',
                desc: 'Centralized authentication with MFA and Zero Trust architecture for distributed environments.',
                action: 'Go',
                url: import.meta.env.VITE_AUTH_URL || 'https://bravexcolombia.com/auth',
              },
              vps: {
                title: 'VerterVPS',
                desc: 'Scalable virtual instances with total environment control and dedicated resources.',
                action: 'Go',
                url: import.meta.env.VITE_VPS_URL || 'https://bravexcolombia.com/vps',
              },
              gateway: {
                title: 'API Gateway',
                desc: 'Orchestration, rate limiting, and unified entry point for microservices.',
                action: 'Go',
                url: import.meta.env.VITE_GATEWAY_URL || 'https://bravexcolombia.com/api-gateway',
              },
              balancer: {
                title: 'Managed Load Balancing',
                desc: 'Intelligent traffic distribution with automatic failover, real-time health monitoring, and horizontal scalability for high-availability environments.',
                action: 'Go',
                url: import.meta.env.VITE_BALANCER_URL || 'https://bravexcolombia.com/load-balancing',
              },
            },
          },
          compliance: {
        ...
        translation: {
          ...
          services: {
            ...
            items: {
              ...
              balancer: {
                title: 'Balanceo de Carga Gestionado',
                desc: 'Distribución inteligente de tráfico con conmutación por error automática, monitoreo de salud en tiempo real y escalabilidad horizontal para entornos de alta disponibilidad.',
                action: 'Ir',
                url: import.meta.env.VITE_BALANCER_URL || 'https://bravexcolombia.com/load-balancing',
              },
            },
